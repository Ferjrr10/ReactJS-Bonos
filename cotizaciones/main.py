...
# Enviar DF
#try:
AL29D_Precio_Fecha = AL29D_DataFrame.drop(columns= ['Apertura', 'Máximo', 'Mínimo', 'Símbolo', 'Monto Negociado'])
...
AL29D_toList = AL29D_Precio_Fecha.values.tolist()

for i in AL29D_toList:
